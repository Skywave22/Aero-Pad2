package com.aeropad.remote.ui.widgets
...
interface WidgetEvents {
    ...
    fun onSwipe(widget: WidgetSpec, direction: com.aeropad.remote.domain.SwipeDirection) {}
...
fun LayoutCanvas(
    ...
    BoxWithConstraints(modifier = modifier.fillMaxSize()) {
        ...
        layout.widgets.filter { it.style.visible }.forEach { widget ->
            ...
            val minTouch = com.aeropad.remote.ui.theme.Dimens.TOUCH_TARGET
        ...
        modifier = Modifier
            ...
            .pointerInput(widget.id + "-swipe") {
                ...
                detectDragGestures(
                    ...
                    onDragEnd = {
                        val dir = com.aeropad.remote.domain.SwipeGestures.classify(totalX, totalY)
                        if (dir != com.aeropad.remote.domain.SwipeDirection.NONE) {
