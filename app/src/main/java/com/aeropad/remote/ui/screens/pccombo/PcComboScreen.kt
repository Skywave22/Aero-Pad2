package com.aeropad.remote.ui.screens.pccombo
...
import com.aeropad.remote.viewmodel.PcComboViewModel
import com.aeropad.remote.viewmodel.ScrollBarSide
...
fun PcComboScreen(
    ...
    if (showVoiceSheet) {
        com.aeropad.remote.ui.components.VoiceInputSheet(onDismiss = { showVoiceSheet = false })
    }
}
