package com.aeropad.remote.data.keyboard
...
class KeyboardLayoutStore @Inject constructor(
    ...
    val comboScrollSide: Flow<com.aeropad.remote.viewmodel.ScrollBarSide> = safePrefs.map { p ->
        runCatching {
            com.aeropad.remote.viewmodel.ScrollBarSide.valueOf(
                p[Keys.COMBO_SCROLL_SIDE] ?: "RIGHT"
            )
        }.getOrDefault(com.aeropad.remote.viewmodel.ScrollBarSide.RIGHT)
    }
    ...
    suspend fun setComboScrollSide(side: com.aeropad.remote.viewmodel.ScrollBarSide) {
        runCatching {
