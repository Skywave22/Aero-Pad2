...
import com.aeropad.remote.domain.MacroRecorder
import com.aeropad.remote.domain.SwipeDirection
import com.aeropad.remote.domain.SwipeGestures
import com.aeropad.remote.model.HidAction
import com.aeropad.remote.model.MouseButton
import com.aeropad.remote.model.macros.MacroStep
...
class GestureAndRecorderTest {
    ...
    fun `recorder caps step count`() {
        ...
        assertTrue(rec.stop().size <= com.aeropad.remote.model.macros.MacroSpec.STEPS_MAX)
    }
